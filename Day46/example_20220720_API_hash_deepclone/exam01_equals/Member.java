...
public class Member {
	...
	//오버라이딩은 상속을 받아서 재정의하는 건데, Member는 상속은 어디서?
	...
	//어떤 클래스든 Object 객체를 모두 상속받기 떄문에 최고 부모 클래스인 Object로 "자동 형변환"이 가능하다
	//어디까지나 타입의 형변환입니다.(인스턴스의 타입이 바뀌는 게 아닙니다~)
	//Member obj4 = new Member("blue"); > Object obj4 = new Member("blue);

	@Override
	public boolean equals(Object obj) {
		//실제로 구현된 인스턴스의 타입은 Member 이기 때문에 if문에 true가 뜹니다
	...
	@Override
	public int hashCode(){
		//String 문자열은 상수풀이기 때문에 같은 주소를 가르칠 컷이고
