...
public class BoardServiceImpl implements BoardService {
    ...
    public List<Board> getBoardList() {
        System.out.println("(List<Board>) boardRepo.findAll() : " + (List<Board>) boardRepo.findAll());
    ...
    public void insertBoard(Board board) {
        System.out.println("boardRepo.save(board) : " + boardRepo.save(board));
        boardRepo.save(board);
    }

    @Override
    public Board getBoard(Board board) {
        System.out.println("boardRepo.findById(board.getSeq()).get() : " + boardRepo.findById(board.getSeq()).get());
    ...
    public void updateBoard(Board board) {
        ...
        System.out.println("boardRepo.save(findBoard) : " + boardRepo.save(findBoard));
    }
