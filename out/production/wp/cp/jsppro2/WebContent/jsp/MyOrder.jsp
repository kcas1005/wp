...
RecordsDao ordDao = new RecordsDao();
RecordsVo ordVo = new RecordsVo();

ArrayList<RecordsVo> ovo = new ArrayList<RecordsVo>();
...
<div class = "mypageIn">
	...
	<div class = "mypageMain">
		...
		<div class = "mypageCountent mypageCountent_order" id="order">
			<table>
				<tr>
					<td>상품번호</td>
					<td colspan="2">상품명</td>
				...
				<%
					...
					for(int i = 0 ; i < 10; i++){
						...
						out.print("<td  colspan='2'><a href='#'><img src='../image/"+proVo.getProduct_img()+"' width='100px'></a>");
						out.print("<a href='content.jsp?product_no="+proNum+"&reviewpage=1&reviewcategory=0'>"+proName+"</a></td>");
						out.print("<td>"+p_state+"</td>");
						out.print("<td>"+p_date+"</td>");
						out.print("<td><input type='button' name='product' class = 'cartIn d_btn' value = '삭제' onclick='delOrder("+proNum+")'></td>");
						out.print("</tr>");
						orderar++;
					}
				%>
