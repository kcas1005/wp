...
<title>상품리스트</title>
<style>
header #header ul.menu>li:nth-child(2) a{background: #fff; color:#ff6e75;}
...
<h1>여성구두</h1>
	...
	<div id="link_number" style="text-align:center;">
		...
		$(document).ready(function(){
			$("#link_number a").css({"color":"#999" , "font-weight":"normal"});
			$("#link_number a:nth-child(<%=pagenumber %>)").css({"color":"black" , "font-weight":"bold"});
			$("#product_list>ul.product_list01 li a").css({"color":"#999" , "font-weight":"normal"});
			$("#product_list>ul.product_list01 li:nth-child(<%=pageoffset %>) a").css({"color":"#000" , "font-weight":"bold"});
		})
		</script>
