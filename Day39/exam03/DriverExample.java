...
public class DriverExample {
	public static void main(String[] args) {
		...
		/*Taxi taxi = new Taxi();
		Vehicle bus_novice = new Novice();
		Vehicle bus_Expert = new Expert();
		Vehicle bus_Master = new Master();



		//버스 일반도로 운행
		driver.drive(bus_novice);
		...
		//버스 요금 정검
		driver.driveCheck(bus);

		// 하이패스 입장
		driver.hipassenter(bus);

		// 하이패스 퇴장
		driver.hipassexit(bus_Master);*/
