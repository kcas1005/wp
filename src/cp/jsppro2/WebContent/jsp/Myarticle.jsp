			...
			<table>
				...
				<%
					...
					for(int i = 0 ; i < 10; i++){
						...
						if(cate == 1){
							out.print("<td><a href='content1.jsp?reviewpage=1&product_no="+proNum+"&reviewcategory=2'>"+tile+"</a></td>");
						}else{
							out.print("<td><a href='content2.jsp?reviewpage=1&product_no="+proNum+"&reviewcategory=3'>"+tile+"</a></td>");
						}
