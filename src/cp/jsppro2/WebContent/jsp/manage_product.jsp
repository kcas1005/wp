...
%>
		...
		<div class="regfrm">
			...
			<%
				if(no == 0)
					out.print("action='regProductpro.jsp'");
				else
					out.print("action='reviseProductpro.jsp'");
			%>
			>
			<input type="hidden" name="no" value="<%=no %>">
				<table id="regTable">
					...
					<tr>
						<td>상품 이미지&nbsp;&nbsp;<br>&nbsp;</td>
						<td>:<br>&nbsp;</td>
						<td><input type="file" name="img" id="img"><br>&nbsp;</td>
					</tr>
					<tr>
						<td>상품 설명<br>&nbsp;</td>
						<td>:<br>&nbsp;</td>
						<td><input type="file" name="dec" id="dec"><br>&nbsp;</td>
					</tr>
					<tr>
						<td>가격<br>&nbsp;</td>
						<td>:<br>&nbsp;</td>
