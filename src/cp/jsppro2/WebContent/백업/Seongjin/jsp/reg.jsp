...
<script type="text/javascript">
	...
	function openConfirmid(joinForm) {
		...
		open(
				url,
				"confirm",
				"toolbar=no,location=no,status=no,scrollbars=no,resizable=no,width=310,height=180");
	}
	function reId(){
								...
								<tbody>
									<tr>
										...
										<!--onkeydown은 키보드 입력시 발생하는 이벤트 대략 중복체크 하고 난 뒤 입력값을 바꾸면 중복체크가 되지 않은 것으로 처리  -->
											<td><input type="hidden" value="0" id="sameId"
											name="sameId"> <input type="text" id="id" name="id" pattern=".{4,16}" required title="글자 수를 4~16자 사이로 입력해주세요." onchange="reId()">
											<!-- onkeydown="inputIdChk()" --> <span id="idMsg"></span>
											(영문소문자 / 숫자, 4~16자)&nbsp; &nbsp; &nbsp; <!-- 중복확인 클릭시 아이디 중복확인 창을 띄움 -->
											<input type="button" value="중복확인"
											onclick="openConfirmid(this.form)"> <!-- 아이디 중복 체크 했는지 판단하는 부분 hidden의 value가 idUncheck이면 중복체크 하지 않은 것 -->
									</tr>
									<tr>
										<th scope="row">비밀번호</th>
										<td><input id="pw" name="pw" type="password"> <!-- pattern=".{10,16}" required
											title="글자 수를 10~16자 사이로 입력해주세요."  -->(영문 대소문자/숫자/특수문자 모두 조합,
											10자~16자)</td>
									</tr>
									<tr>
										<th scope="row">비밀번호 확인</th>
										<td><input id="pw_confirm" name="pw_confirm"
											type="password"> <!-- pattern=".{10,16}" required title="글자 수를 10~16자 사이로 입력해주세요." -->
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><span id="postContents"> <input type="text"
												id="postcode" name="post_num"> <input type="button"
												onclick="Postcode()" value="우편번호 찾기"><br /> <input
												type="text" id="address" name="address" maxlength="100">(기본주소)<br>
												<input type="text" id="detailAddress" name="address2"
												maxlength="100">(상세주소)
										</span>
									</tr>
									<tr>
										<th scope="row" id="birthTitle">생년월일</th>
										<td><span id="birthContents"> <input type="text"
												name="birth" maxlength="6">
										</span><span>생년월일을 6자리 숫자로 입력해주세요.(예:920331)</span>
									</tr>
									<tr>
										<th scope="row" id="messageTitle">배송메세지</th>
										<td><span id="messageContents2"> <input
									...
									<!-- <tr class="displaynone">
										...
										<td><label for="is_sms0"> <input id="is_sms0"
												name="is_sms" value="T" type="checkbox"> 동의함
										</label>
									...
									<!-- <tr>
										...
										<td><label for="is_news_mail0"> <input
												id="is_news_mail0" name="is_news_mail" value="T"
												type="checkbox"> 동의함
										</label>
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.</textarea>
							...
							<div class="btnArea.center">
								<input type="submit" value="yes, I agree" class="reg_btn">
								<input type="button" value="no thanks" class="reg_btn"
