...
<%@ page import="shopping.vo.CartVo" %>
		...
		<table id="table2">
			...
			<tr>
				<td><input type="checkbox" checked name="chkbox"
					...
					%>
				></td>
				<td><a href="test.jsp" target="_blank"> <%= pd.selectNameByNo(no) %> </a></td>
